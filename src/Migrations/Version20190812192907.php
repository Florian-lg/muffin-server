 ...
 */
final class Version20190812192907 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE player (id INT AUTO_INCREMENT NOT NULL, role_id INT DEFAULT NULL, game_id INT DEFAULT NULL, display_name VARCHAR(255) NOT NULL, is_president TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_98197A65D60322AC (role_id), INDEX IDX_98197A65E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
