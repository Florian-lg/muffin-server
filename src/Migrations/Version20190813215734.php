 ...
 */
final class Version20190813215734 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE player CHANGE role_id role_id INT DEFAULT NULL, CHANGE game_id game_id INT DEFAULT NULL');
